...
kung_fu_panda = media.Movie(
    ...
    "https://www.youtube.com/watch?v=PXi3Mv6KMzY")  # noqa
chicken_run = media.Movie(
    ...
    "https://www.youtube.com/watch?v=jVdlxwX6A7g")  # noqa
...
modern_times = media.Movie(
    ...
    "https://upload.wikimedia.org/wikipedia/en/6/6e/Moderntimes.jpg",  # noqa
    "https://www.youtube.com/watch?v=GLeDdzGUTq0")  # noqa
